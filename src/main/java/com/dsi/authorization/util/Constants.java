...
public class Constants {
    ...
    public static final String AUTHORIZATION_SERVICE_0002 = "authorization_service_0002";
    public static final String AUTHORIZATION_SERVICE_0002_DESCRIPTION = "Create failed.";

    public static final String AUTHORIZATION_SERVICE_0003 = "authorization_service_0003";
    public static final String AUTHORIZATION_SERVICE_0003_DESCRIPTION = "Update failed.";

    public static final String AUTHORIZATION_SERVICE_0004 = "authorization_service_0004";
    public static final String AUTHORIZATION_SERVICE_0004_DESCRIPTION = "Delete failed.";

    public static final String AUTHORIZATION_SERVICE_0005 = "authorization_service_0005";
    public static final String AUTHORIZATION_SERVICE_0005_DESCRIPTION = "Not found.";

    public static final String AUTHORIZATION_SERVICE_0006 = "authorization_service_0006";
    public static final String AUTHORIZATION_SERVICE_0006_DESCRIPTION = "Instance initialization failed.";

    public static final String AUTHORIZATION_SERVICE_0007 = "authorization_service_0007";
    public static final String AUTHORIZATION_SERVICE_0007_DESCRIPTION = "Token expired.";

    public static final String AUTHORIZATION_SERVICE_0008 = "authorization_service_0008";
    public static final String AUTHORIZATION_SERVICE_0008_DESCRIPTION = "Params are missing.";

    public static final String AUTHORIZATION_SERVICE_0009 = "authorization_service_0009";
    public static final String AUTHORIZATION_SERVICE_0009_DESCRIPTION = "JSON read/write failed.";

    public static final String AUTHORIZATION_SERVICE_0010 = "authorization_service_0010";
